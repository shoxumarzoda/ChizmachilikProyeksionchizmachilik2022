...
import uz.ithelp.chizmachilikproyeksionchizmachilik2022.ui.notifications.NotificationsFragment;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserAdapterViewHolder> implements Filterable {
    ...
    public UserAdapter(List<ModelRcycler> userModelList, NotificationsFragment selectedUser) {
